...
module.exports = {
  ...
  defaultBucketKey: 'forge-adn-bucket',

  // Replace with your own API credentials:
  // http://developer.autodesk.com
  credentials: {

    ConsumerKey: process.env.CONSUMERKEY || 'uGaaGcTdC9AAPpX9BONJpDnvrw6bPVSo', 
    ConsumerSecret: process.env.CONSUMERSECRET || 'EWStudJPRPOoAqVA'
  },
