...
//
// Modified from this http://adndevblog.typepad.com/cloud_and_mobile/2015/12/change-color-of-elements-with-view-and-data-api.html
//
///////////////////////////////////////////////////////////////////////////////
...
Autodesk.ADN.Viewing.Extension.Color = function (viewer, options) {
    ...
    _self.load = function () {
        ...
        Autodesk.Viewing.Viewer3D.prototype.setColorMaterial = function (objectIds, color) {
            var materialName = newGuid();
            var material = addMaterial(materialName, color);
            ...
            for (var i = 0; i < objectIds.length; i++) {
                ...
                it.enumNodeFragments(dbid, function (fragId) {
                    ...
                    viewer.impl.addOverlay(materialName, renderProxy.meshProxy);
        ...
        /*
        // this modified version will not support this restore... for now.
        //
        //
        Autodesk.Viewing.Viewer3D.prototype.restoreColorMaterial1 = function (objectIds) {
            for (var i = 0; i < objectIds.length; i++) {
                var dbid = objectIds[i];
